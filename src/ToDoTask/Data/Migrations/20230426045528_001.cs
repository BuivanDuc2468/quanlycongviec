...
namespace ToDoTask.Data.Migrations
{
    ...
    public partial class _001 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "StatisticPercents",
                columns: table => new
                {
                    PercentWaitting = table.Column<int>(type: "int", nullable: false),
                    PercentProgress = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Waitting = table.Column<int>(type: "int", nullable: false),
                    Processing = table.Column<int>(type: "int", nullable: false),
                    SlowProgress = table.Column<int>(type: "int", nullable: false),
                    OnSchedule = table.Column<int>(type: "int", nullable: false),
                    TotalJob = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Jobs_ProjectUsers_UserId_ProjectId",
